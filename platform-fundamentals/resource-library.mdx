...
The Open Impact Resource Library is a curated, shared collection of practices, tools, and knowledge intended to support the wellbeing of planet, people, and place. 

<Columns cols={2}>
  <Column>
    <u>Open Future Coalition’s current focus areas include:</u>
  ...
  <Column>
    <u>Resources added to the public library are intended to:</u>

    - Support practical implementation and applied learning
    - Enable reuse across regions and contexts
    - Reflect community-rooted and place-based approaches
    - Contribute to a living body of shared knowledge
  </Column>
</Columns>
