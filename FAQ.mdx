...
<AccordionGroup>
  ...
  <Accordion title="Can my organization customize Open Impact?">
    Yes. Open Impact is designed to be highly adaptable and can be configured to support a wide range of workflows, data models, member roles, forms, dashboards, resource libraries, and collaboration structures. Rather than prescribing a single way of working, the platform is intended to provide flexible infrastructure that organizations and networks can tailor to their own needs.<br /><br />Additionally, we partner with organizations and networks to provide White Label versions of the Open Impact platform, which remain interoperable with our wider network while providing branded, curated spaces and custom configuration. We also partner with regional and sectoral leaders to co-develop custom features to meet specific use cases, while extending that functionality to our wider network. To explore these possibilities, please reach out to collaborate@openfuturecoalition.org. 
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  ...
  <Accordion title="How do I use management/tasks to manage project workflows?">
    You can organize workflows by assigning tasks and tracking their progress through visual Gantt chart and swimlane views on a project or profile's "management" tab. Through these views, you can edit your task start and end dates, assignees, descriptions, and attachments, as well as organize them by tag and priority. 
  </Accordion>

  <Accordion title="How do I use project management to deliver a training curriculum or learning program?">
    Project spaces allow facilitators to deliver curricula by guiding participants through structured tasks and defined stages. When assigning tasks, such as an assignment or module, use “Bulk Assign” to assign a copy of a task that each assignee must complete.
  </Accordion>
...
<AccordionGroup>
  <Accordion title={"I don't see an \"add resource\" button on my profile. How do I add a resource?"}>
    To have access to the Resource Publishing tool, you must first be designated as a resource author. This can be achieved by attending a Resource Author training, with the Open Future Coalition team or an affiliated network partner. 
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="How do I add a customized form to my library?">
    Click on the avatar on the top right of your screen. Towards the bottom of that menu, click "My Workflows." Here, you can either create a new form and publish it to an existing Template Collection, or create and organize Template Collections. 
  </Accordion>

  <Accordion title="What is the difference between a Form, a Template, and a Task? ">
    A form is a series of fields that can be saved in a particular format, then saved and made available through a Template. Template Collections are named collections of forms, which can be versioned and shared across many contexts, and accessed in the "Add Task" workflow in profiles and projects. A task is a form template that has been assigned to a specific person or group of people, which is now ready to accept unique data. 
  </Accordion>

  <Accordion title="If my template is used across multiple projects, who can see the data? ">
    Even if a template is reused across multiple projects, data access is still governed by project and task-level privacy settings. Task-level data can only be viewed by assignees, and project managers in the project in which a task has been assigned. 
  </Accordion>
</AccordionGroup>
