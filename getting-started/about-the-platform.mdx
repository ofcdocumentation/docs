...
<Frame>
  ![About Hero](/images/about_hero.webp)
</Frame>
...
<Columns cols={3}>
  <Column>
    <Card title="Knowledge Sharing" icon="thought-bubble">
      through shared community spaces, calendars, news feeds, and discussion tools
    </Card>

    <Card title="Integrated Impact Measurement and Reporting" icon="bullseye-arrow">
    </Card>
  </Column>
  <Column>
    <Card title="Resource Publishing" icon="books">
      and documentation (files, templates, training materials, and toolkits)
    </Card>

    <Card title="Data Visualization and Dashboards " icon="chart-mixed">
      for storytelling and decision-making
    </Card>
  </Column>
  <Column>
    <Card title="Project Coordination" icon="project-diagram">
...
<Columns cols={2}>
  ...
  <Column>
    <Frame>
      ![Regional Food](/images/regional_food.webp)
    </Frame>
  </Column>
</Columns>
...
<Columns cols={2}>
  ...
  <Column>
    <Frame>
      ![Landscape Scale](/images/landscape_scale.webp)
    </Frame>
  </Column>
</Columns>
...
<Columns cols={2}>
  ...
  <Column>
    <Frame>
      ![Community Resilience](/images/community_resilience.webp)
    </Frame>
  </Column>
</Columns>
...
<Columns cols={2}>
  ...
  <Column>
    <Frame>
      ![Distributed Learning](/images/distributed_learning.webp)
    </Frame>
  </Column>
</Columns>